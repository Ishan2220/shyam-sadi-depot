        ...
        <div className="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between relative">
          ...
          <Link to="/" className="flex-shrink-0 flex items-center gap-4 group mr-8 lg:relative absolute left-1/2 -translate-x-1/2 lg:left-auto lg:translate-x-0">
            <img 
              ...
              className="h-20 md:h-20 w-auto object-contain rounded-full shadow-md border border-[var(--primary)]/10 group-hover:scale-105 transition-transform duration-500" 
            />
